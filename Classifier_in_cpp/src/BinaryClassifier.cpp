...
BinaryClassifier::BinaryClassifier(const string model_path, const string prediction_mode)
        :
        ...
        input_features(15) // TODO magic number
{
    ...
    auto status = LoadSavedModel(SessionOptions(), RunOptions(), saved_model_dir,  {kSavedModelTagServe}, &bundle);
